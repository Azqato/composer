...
window.STRATEGIES_DATA = [
  ...
  },
  {
    ...
    "risk_profile": {
      ...
      "backtest_limits": "Roughly 5.4 years from March 2021, bounded by GDXU's own launch. The record is driven primarily by the explosive 2024 to 2026 gold bull market and contains none of the 2022 commodity bear, so the full drawdown profile over a complete cycle is simply unknown. Its Calmar is exceptional by any measure and it comes entirely from that one window.",
