...
window.STRATEGIES_DATA = [
  ...
  },
  {
    ...
    "author_note": "Note: Backtest covers approximately 2.4 years (about 605 trading days from early 2024). All metrics reflect this short window. Interpret with caution. Metrics are accurate as of the last_updated date."
  },
  {
    "slug": "holy-grail",
    ...
    "ai_summary": [
      ...
      "Over a long 15-year backtest it returns 150% annualized with a 1.77 Sharpe and 3.17 Calmar, while the 47% max drawdown and 63% volatility mark it as aggressive. The lengthy test window through multiple bear markets is a meaningful strength, and the explicit short and hedge branches mean it is built to profit from, not merely survive, downturns. It suits investors who want active bull-and-bear leveraged tech exposure governed by a transparent moving-average regime rule."
    ],
    "how_it_works": [
  ...
  },
  {
    ...
    "ai_summary": [
      ...
      "It shows 229% annualized over a roughly 4.3-year (about 1,080-day) backtest with a 2.18 Sharpe and 5.14 Calmar against a 45% max drawdown. The strong ratios are attractive, but the short record begins around mid-2022 and is skewed toward the high-volatility 2022 to 2025 environment in which fade-the-extreme tactics thrive; the same approach can bleed in calm, persistently trending markets where the worst performer keeps losing. Treat the impressive metrics as period-specific and the strategy as a tactical, volatility-dependent mean-reversion play."
    ],
    "how_it_works": [
  ...
  },
  {
    ...
    "ai_summary": [
      ...
      "Across roughly 14 years it returns 162% annualized with a strong 2.14 Sharpe and 3.58 Calmar against a 45% max drawdown and 51% volatility. The combination of a long backtest, parallel-system diversification, and layered bear protocols gives it one of the more robust risk-adjusted profiles among the original (non-zoop) strategies. The cost is complexity, since many interacting components are harder to audit and carry more parameter risk, but the multi-system design is a deliberate hedge against any single signal failing."
    ],
    "how_it_works": [
  ...
  },
  {
    ...
    "ai_summary": [
      ...
      "Over a long 14-year backtest it returns 110% annualized, but the risk is severe: a 69% max drawdown, 67% volatility, and the weakest risk-adjusted figures of this group (1.44 Sharpe, 1.60 Calmar). The noteworthy characteristic is that the strategy takes very large losses relative to its returns, since fading extreme single-sector moves works until a move keeps going, and 3x chip ETFs punish a wrong-way bet harshly. It is a high-conviction, high-pain semiconductor tool, not a balanced allocation."
    ],
    "how_it_works": [
  ...
  },
  {
    ...
    "ai_summary": [
      ...
      "It returns 135% annualized over a long 15-year backtest but carries the deepest drawdown in the entire library at 88%, with extreme 86% volatility and weak 1.43 Sharpe and 1.54 Calmar ratios. Two cautions dominate. First, an 88% drawdown means the strategy lost nearly nine-tenths of peak value at its worst, which few investors could hold through. Second, RL and optimized strategies are especially prone to overfitting, because thresholds tuned to maximize a past backtest often degrade out-of-sample. The long test window helps, but the algorithmic curve-fitting risk and catastrophic drawdown are the headline concerns."
    ],
    "how_it_works": [
  ...
  },
  {
    ...
    "ai_summary": [
      ...
      "This is the weakest risk-adjusted profile in the library, and its metrics should be read as a cautionary example: 75% annualized over roughly 14 years, but an 86% max drawdown, the second deepest here behind SOXL Growth (Original), with a 1.11 Sharpe and a Calmar of just 0.87, meaning the annualized return is actually smaller than the maximum loss endured to earn it. Fading single-sector momentum without a strong regime gate exposes it to ruinous trends where the 'extreme' keeps extending. The long backtest only underscores that the poor ratios are structural, not a small-sample artifact; this strategy illustrates how high single-sector leverage can produce large returns and unacceptable risk simultaneously."
    ],
    "how_it_works": [
  ...
  },
  {
    ...
    "ai_summary": [
      ...
      "Over roughly 14 years it returns 71% annualized with a modest 1.17 Sharpe, a 1.09 Calmar, and a deep 65% max drawdown. The weak Calmar signals the core issue: the sector-momentum sleeve still suffers large drawdowns, and the VIXM hedge, which bleeds during calm markets, drags on returns more than it protects in this configuration. The diversified sector universe is genuinely broad, but the metrics suggest the hedge-plus-rotation balance is not well tuned; it is a moderate strategy whose risk outweighs its return relative to the leveraged peers here."
    ],
    "how_it_works": [
