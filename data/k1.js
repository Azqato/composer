window.K1_DATA = {
 "refreshed_at": "2026-08-27 10:11:08",
 "source": "etfdb.com",
 "tickers": {
  "AAPL": {
   "name": null,
  ...
  "SOYB": {
   ...
   "agrees": false,
   "checked": "2026-08-27",
   "override": "etfdb's capital gains rates for this fund (39.60%/20.00%) do not match its own Commodity Pool structure, so the two readings disagree. The structure is the correct one: SEC EDGAR shows the shares are issued by Teucrium Commodity Trust, which files a 10-K and does not appear in EDGAR's register of 1940-Act funds. It sends a K-1."
  },
  "SPHB": {
  ...
  "TAGS": {
   ...
   "agrees": false,
   "checked": "2026-08-27",
   "override": "Same as SOYB, and the same issuer. The rates on etfdb disagree with its own Commodity Pool structure; EDGAR shows Teucrium Commodity Trust, a 10-K filer absent from the 1940-Act fund register. It sends a K-1."
  },
  "TAIL": {
