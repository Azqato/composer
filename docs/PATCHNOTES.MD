...
Added **Half Low Catch s90 50/40 maxDD** (`s90-half-low-catch`) — a multi-asset extreme dip-buying strategy that pairs the 2026 Frontrunner with a dedicated low-catching component.
